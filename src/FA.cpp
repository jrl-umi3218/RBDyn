...
void forwardAcceleration(const MultiBody & mb, MultiBodyConfig & mbc, const sva::MotionVecd & A_0)
{
...
void sForwardAcceleration(const MultiBody & mb, MultiBodyConfig & mbc, const sva::MotionVecd & A_0)
{
